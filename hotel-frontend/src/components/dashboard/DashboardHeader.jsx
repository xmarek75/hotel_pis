...
export default function DashboardHeader({ viewTitle, activeView, setActiveView, handleLogout }) {
  return (
    <header className="dashboard-topbar">
      <div className="dashboard-topbar__left">
        ...
        <div className="dashboard-nav-row">
          ...
          <button className="btn btn--secondary dashboard-topbar__logout" onClick={handleLogout} type="button">
            Odhlásit
          </button>
        </div>
      </div>
