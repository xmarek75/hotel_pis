...
// FIXME: room.active is not implemented
...
export default function RoomModal({roomId, onClose}) {
  ...
  const handleSubmit = () => {
    ...
    mutate(payload, {
      onSuccess: (data) => {
        setSuccessMessage(form?.id ? "Pokoj byl úspěšně uložen." : "Pokoj byl úspěšně vytvořen.");
          ...
          <div className="reservation-form-grid">
            ...
            <label>
              ...
              {roomTypes.length > 0 ? (
                ...
                <input value={form.typeName} onChange={(e) => updateForm("typeName", e.target.value)} />
              )}
            </label>
            <label>
              <span>Kapacita</span>
